      ...
      <SafeAreaView style={{ backgroundColor: COLORS.white, flex: 1 }}>
        <ScrollView >
          ...
          <View style={{
            ...
            }}>التقط صورة البطاقة الشخصية للأمام والخلف
          ...
          {frontImage ?
            <>
              <View
                ...
                <ImageBackground source={{ uri: selectFrontImage }} style={{
          ...
          {back_image ?
            <>
              <View style={{ alignItems: "center", justifyContent: "center", marginVertical: RFPercentage(3) }}>
                <ImageBackground source={{ uri: selectBackImage }} style={{
                  width: Sizes.width * 0.7,
                  height: Sizes.height * 0.22
                }}>
                  <TouchableOpacity onPress={() => {
